...
def threaded_reader(items_to_read, reader, max_threads=4):
    ...
    def thread_process():
        ...
        while source:
            ...
            for chunk in dictset.page_dictset(source_reader, 512):
                reply_queue.put(chunk)  # this will wait until there is a free slot
            try:
                source = source_queue.pop(0)
            except IndexError:
                source = None
